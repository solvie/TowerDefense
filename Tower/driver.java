...
public class driver{
	public static void main(String[] args) {
		...
		towerlist.add(testBasic);
		towerlist.add(testFreezing);
		...
		/*all towers scan through and shoot
		...
		System.out.println("The basic tower will now be sold for " + testBasic.value + ".");
		testBasic.sellTower(testBasic);

		testFreezing.increaseLevel();
		System.out.println("Freezing tower was upgraded, new level is " + testFreezing.level 
			+ " and new cost to upgrade further is " + testFreezing.cost + ".");
